...
if you want to test directly, please do not run 'python rnn_pretrain.py ...' and run 'python rnn_finetune.py ... --is_finetune 0'. This will test the model through the prepared ckpts in '/saved_models' (ignore the patchtst in the name of ckpts, that is RNN in practice)
