...
def get_dls(params):
    ...
    if params.dset == 'ettm1':
        ...
        root_path = 'src/data/datasets/public/'
        ...
        # root_path = 'src/data/datasets/public/electricity/'
        root_path = 'src/data/datasets/public/'
        size = [params.context_points, 0, params.target_points]
        dls = DataLoaders(
        ...
        # root_path = 'src/data/datasets/public/traffic/'
        root_path = 'src/data/datasets/public/'
        size = [params.context_points, 0, params.target_points]
        dls = DataLoaders(
                datasetCls=Dataset_Custom,
        ...
        # root_path = 'src/data/datasets/public/weather/'
        root_path = 'src/data/datasets/public/'
        size = [params.context_points, 0, params.target_points]
        dls = DataLoaders(
                datasetCls=Dataset_Custom,
        ...
        # root_path = 'src/data/datasets/public/illness/'
        root_path = 'src/data/datasets/public/'
        size = [params.context_points, 0, params.target_points]
        dls = DataLoaders(
                datasetCls=Dataset_Custom,
