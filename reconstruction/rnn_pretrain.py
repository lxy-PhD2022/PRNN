...
parser.add_argument('--hidden_size', type=int, default=512, help='hidden_size of rnn')

args = parser.parse_args()
print('args:', args)
args.save_pretrained_model = 'patchtst_pretrained_cw{}_patch{}_stride{}_epochs-pretrain{}_mask{}_model{}'.format(
    args.context_points, args.patch_len, args.stride, 
    args.n_epochs_pretrain, args.mask_ratio, args.pretrained_model_id
)
...
def find_lr():
    ...
    # get callbacks
    cbs = [RevInCB(dls.vars, affine=True, denorm=False)] if args.revin else []
